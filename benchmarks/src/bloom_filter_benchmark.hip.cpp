...
int main(int argc, char *argv[])
{
    ...
    data_t* tp_data_h; hipHostMalloc(&tp_data_h, sizeof(data_t)*n); HIPERR
    data_t* fp_data_h; hipHostMalloc(&fp_data_h, sizeof(data_t)*n); HIPERR
    data_t* tp_data_d; hipMalloc(&tp_data_d, sizeof(data_t)*n); HIPERR
    data_t* fp_data_d; hipMalloc(&fp_data_d, sizeof(data_t)*n); HIPERR

    bool* flags_h; hipHostMalloc(&flags_h, sizeof(bool)*n); HIPERR
    bool* flags_d; hipMalloc(&flags_d, sizeof(bool)*n); HIPERR
    ...
    hipMemcpy(tp_data_d, tp_data_h, sizeof(data_t)*n, H2D); HIPERR
    hipMemcpy(fp_data_d, fp_data_h, sizeof(data_t)*n, H2D); HIPERR
    hipMemset(flags_d, 0, sizeof(bool)*n); HIPERR
    ...
    hipMemcpy(flags_h, flags_d, sizeof(bool)*n, D2H); HIPERR

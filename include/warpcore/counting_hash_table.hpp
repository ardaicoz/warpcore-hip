#ifndef WARPCORE_COUNTING_HASH_TABLE_HPP
#define WARPCORE_COUNTING_HASH_TABLE_HPP
...
public:
     ...
     */
    HOSTQUALIFIER INLINEQUALIFIER
    status_type peek_status(hipStream_t stream = 0) const noexcept
    {
     ...
     */
    HOSTQUALIFIER INLINEQUALIFIER
    status_type pop_status(hipStream_t stream = 0) noexcept
    {
...
#endif /* WARPCORE_COUNTING_HASH_TABLE_HPP */
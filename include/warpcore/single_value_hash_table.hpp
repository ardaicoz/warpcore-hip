#ifndef WARPCORE_SINGLE_VALUE_HASH_TABLE_HPP
#define WARPCORE_SINGLE_VALUE_HASH_TABLE_HPP
...
public:
        ...
        typename StatusHandler::base_type * const status_out = nullptr) const noexcept
    {
        ...
        hipMemcpyAsync(&num_out, tmp, sizeof(index_type), D2H);
...
#endif /* WARPCORE_SINGLE_VALUE_HASH_TABLE_HPP */

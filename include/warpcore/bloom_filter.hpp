#ifndef WARPCORE_BLOOM_FILTER_HPP
#define WARPCORE_BLOOM_FILTER_HPP
...
public:
    ...
    explicit BloomFilter(
        ...
        is_copy_(false)
    {
        hipMalloc(&bloom_filter_, sizeof(slot_type) * num_slots_);
    ...
    ~BloomFilter() noexcept
    {
        if(!is_copy_)
        {
            if(bloom_filter_ != nullptr) hipFree(bloom_filter_);
        }
    }
    #endif
...
#endif /* WARPCORE_BLOOM_FILTER_HPP */
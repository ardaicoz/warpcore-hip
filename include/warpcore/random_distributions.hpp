#ifndef WARPCORE_RANDOM_DISTRIBUTIONS_HPP
#define WARPCORE_RANDOM_DISTRIBUTIONS_HPP
...
/*! \brief generates \c n uniform random elements on a HIP device
...
/*! \brief generates \c n unique random elements on a HIP device
* \tparam T data type to be generated
* \tparam Rng type of random number generator
* \param[out] out pointer to the output array
* \param[in] n number of elements to generate
...
/*! \brief generates \c n zipf distributed random elements on a HIP device
* \tparam T data type to be generated
* \tparam Rng type of random number generator
...
#endif /* WARPCORE_RANDOM_DISTRIBUTIONS_HPP */
